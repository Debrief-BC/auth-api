    ...
    */
    ...
    'grant_types' => [
        'password' => [
            ...
            'callback' => '\App\Oauth@verifyPasswordGrant',
            'access_token_ttl' => 31540000 // should be 1 hr or 3600
        ],
        'refresh_token' => [
            'class' => '\League\OAuth2\Server\Grant\RefreshTokenGrant',
            'access_token_ttl' => 3600, // should be 1 hr or 3600
            'refresh_token_ttl' => 604800 // should be 1 week or 604800
        ],
        'client_credentials' => [
